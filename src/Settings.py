...
class Settings:
    ...
    # Vocal separation
    separator_backend = SeparatorBackend.DEMUCS  # demucs|audio_separator
    demucs_model = DemucsModel.HTDEMUCS  # htdemucs|htdemucs_ft|htdemucs_6s|hdemucs_mmi|mdx|mdx_extra|mdx_q|mdx_extra_q|SIG
    audio_separator_model = AudioSeparatorModel.BS_ROFORMER  # Best-quality Roformer model (SDR 12.97)
