...
# those files. This script temporarily lifts the protection, pulls,
# re-applies the CUDA configuration and restores the protection - then
# syncs dependencies (without rebuilding the venv from scratch).
